...
export const TodoItem = ({ todo }: Props) => {
  ...
  return (
      <div style={{
        backgroundColor: "rgba(217, 212, 212, 0.56)", 
        marginBottom: "1rem", 
        borderRadius: "0.5rem",
        padding: "0.5rem",
        display: "flex",
    ...
    >
      ...
      <Typography sx={{textDecoration: todo.checked ? "line-through" : "none", color: todo.checked ? "rgba(0, 0, 0, 0.5)" : "auto", }}>{todo.description}</Typography>
      </div>
